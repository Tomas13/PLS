...
public class VolumesRVAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements RecyclerView.OnItemTouchListener {

    private Context context;
    private GestureDetector mGestureDetector;
    private VolumesRVAdapter.OnItemClickListener listener;
    ...
    public VolumesRVAdapter(Activity activity, List<Object> items, VolumesRVAdapter.OnItemCheckedListener listener) {
